...
<div class="container">
  <nav class="top-nav ">
      <ul class="clearfix" style="text-align: center;font-size: 24px">
         author:刘乔木
      </ul>
  </nav>


    <a  href="install" style="display: block;width: 100%;text-align: center;font-size: 24px;text-align: center;padding-top: 30px;" >
        开始安装
    </a>

  <div class="main">
    <h1 class="swoft-title">SRPHP <span class="framework">VERSION </span>
      <small>1.x</small>
    </h1>
  </div>
</div>
