 ...
 * @date 2019/07/05
 */
namespace App\Model\System\Config\Data;
 ...
 * Class ModuleData
 * @since 2.0
 * @Bean(name="Config.ConfigData",scope=Bean::PROTOTYPE)
 *
 */
class ConfigData extends BaseData
{
    /**
     * @Inject("Config.ConfigDao")
     * @var \App\Model\System\Config\Dao\ConfigDao
     */
    private $dao;
