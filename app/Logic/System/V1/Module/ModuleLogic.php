...
namespace App\Logic\System\V1\Module;
    ...
    public function create( $response, $request)
    {
        ...
        if($boll){
            ...
            $arr = [
                ...
                'DataPath' =>  strval(env('SWOFT_PATH')) .'/app/Model/Local/'.$data['name'].'/Data',
                'DaoPath' =>  strval(env('SWOFT_PATH')) .'/app/Model/Local/'.$data['name'].'/Dao',
                'EnumPath' =>  strval(env('SWOFT_PATH')) .'/app/Model/Local/'.$data['name'].'/Enum',
                'logicPath' =>  strval(env('SWOFT_PATH')) .'/app/Logic/Local/'. strval(env('SYSTEM_VERSION')).'/'.$data['name'],
